...
class Client:
    ...
    def __init__(self, master, serveraddr, serverport, rtpport, filename):
        ...
        self.numFrame = 0  
        self.sliderTick = 0
        self.timeBegin = StringVar(value="00:00:00")
        self.timeAfter = StringVar(value="00:00:00")
       	self.clockEvent = threading.Event()
    ...
    def createWidgets(self):
        ...
        self.setup.grid(row=5, column=0, padx=20, pady=20)

        # Create Play button
        self.start = Button(self.master, width=20, padx=3, pady=3)
        self.start["text"] = "Play"
        self.start["command"] = self.playMovie
        self.start.grid(row=5, column=1, padx=2, pady=2)

        # Create Pause button
        self.pause = Button(self.master, width=20, padx=3, pady=3)
        self.pause["text"] = "Pause"
        self.pause["command"] = self.pauseMovie
        self.pause.grid(row=5, column=2, padx=2, pady=2)

        # Create Teardown button
        self.teardown = Button(self.master, width=20, padx=3, pady=3)
        self.teardown["text"] = "Teardown"
        self.teardown["command"] = self.exitClient
        self.teardown.grid(row=5, column=3, padx=2, pady=2)
        ...
        self.slider.grid(row=3, column=2, columnspan=3, sticky=W+E)
        self.slider.bind("<ButtonRelease-1>", self.forwardMovie)

        self.stamp1 = Label(self.master, width=10, textvariable=self.timeBegin)
        self.stamp1.grid(row=3, column=1, sticky=S)

        self.stamp2 = Label(self.master,  width=10, textvariable=self.timeAfter)
        self.stamp2.grid(row=3, column=5, sticky=S)
        
        # Create a label to display the movie
        self.label = Label(self.master, background='black')
        self.label.grid(row=0, column=1, columnspan=5, rowspan=5, sticky=W+E+N+S, padx=50, pady=50)
    ...
    def updateTimeStamps(self, sliderValue):
        ...
        self.timeBegin.set(datetime.timedelta(seconds=elapsedTime))
        self.timeAfter.set(datetime.timedelta(seconds=self.videoLength - elapsedTime))
    ...
    def setTimeLine(self, timeConfig):
        ...
        self.timeBegin.set("00:00:00")
        self.timeAfter.set(datetime.timedelta(seconds=self.videoLength))
