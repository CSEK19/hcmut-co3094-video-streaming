...
class Client:
	...
	def createWidgets(self):
		...
		# Create Play button		
		self.start = Button(self.master, width=27, padx=3, pady=3)
		self.start["text"] = "Play"
		self.start["command"] = self.playMovie
		self.start.grid(row=1, column=1, padx=2, pady=2)
		
		# Create Pause button			
		self.pause = Button(self.master, width=27, padx=3, pady=3)
		self.pause["text"] = "Pause"
		self.pause["command"] = self.pauseMovie
		self.pause.grid(row=1, column=2, padx=2, pady=2)
		
		# Create Teardown button
		self.teardown = Button(self.master, width=27, padx=3, pady=3)
	...
	#TODO
		...
		if self.begin != 0:
			self.sumTime += time.time() - self.start
